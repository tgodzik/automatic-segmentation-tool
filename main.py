...
if __name__ == "__main__":
    ...
    #segmentation.block_fusion_algorithm(pages, is_measured=True,
    # measure_files=reference,  visualized=False, treshold=0.4)
    ...
    segmentation.tree_segmentation_algorithm(pages, is_measured=True, measure_files=reference, visualized=False)
